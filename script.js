...
const questions = 
[
	new Question(" Первый независимый от халифата эмират образовался в 756 году в", 
	[
	...
	new Question("Какая династия правила раньше Аббасиды или Омеяды", 
	[
		new Answer('Аббасиды', 1),
		new Answer("Омеяды", 0),
		new Answer("Османы", 0),
